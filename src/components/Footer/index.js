        ...
        <div className="footer-contain">
            <div className="footer-container">
                ...
                <div className="footer">
                    ...
                    <p className="footer-white-content">Career@psychiatry.com</p>
                </div>
                <div className="footer">
                    <div className="footer-content">
                        <div className="footer-logo" alt="website logo"></div>
                        <h1 className="footer-heading">PSYCHIATRY</h1>
                    </div>
                    <h1 className="gold-colored-content">Locate us</h1>
                    <p className="footer-white-content">1820 E Ray Road, STE A107, Chandler, Arizona 85225</p>
            ...
            <hr className="hori"/>
            <p className="footer-white-content reserved"> <TbSquareRoundedLetterC />Psychiatry. All rights reserved.</p>
        </div>
    )
}
